...
(function () {
  var MODALS_HTML =
    ...
    '<p class="text-center text-xs text-slate-500">Prefer to talk? <a href="tel:+13030000000" class="font-semibold text-roof-accent hover:underline">+1 (303) 000-0000</a></p></form>' +
    ...
    '<a href="tel:+13030000000" class="mt-5 inline-flex w-full justify-center rounded-2xl bg-roof-accent py-3.5 text-sm font-medium text-white hover:bg-roof-accent-hover transition-colors">Call +1 (303) 000-0000</a>' +
    ...
    '<a href="tel:+13030000000" class="flex w-full items-center justify-center gap-2 rounded-2xl bg-roof-accent py-3.5 text-sm font-medium text-white shadow-lg shadow-roof-accent/25 transition-colors hover:bg-roof-accent-hover">Call dispatch — fastest</a>' +
