...
(function () {
  var MODALS_HTML =
    ...
    '<input id="estimate-phone" name="phone" type="tel" required autocomplete="tel" class="w-full rounded-xl border border-slate-200 px-4 py-3 text-slate-900 outline-none transition-shadow focus:border-roof-accent focus:ring-2 focus:ring-roof-accent/20" placeholder="720 0roofrx" /></div>' +
    ...
    '<p class="text-center text-xs text-slate-500">Prefer to talk? <a href="tel:+17200766379" class="font-semibold text-roof-accent hover:underline">720 0roofrx</a></p></form>' +
    ...
    '<a href="tel:+17200766379" class="mt-5 inline-flex w-full justify-center rounded-2xl bg-roof-accent py-3.5 text-sm font-medium text-white hover:bg-roof-accent-hover transition-colors">Call 720 0roofrx</a>' +
    ...
    '<a href="tel:+17200766379" class="flex w-full items-center justify-center gap-2 rounded-2xl bg-roof-accent py-3.5 text-sm font-medium text-white shadow-lg shadow-roof-accent/25 transition-colors hover:bg-roof-accent-hover">Call dispatch — fastest</a>' +
